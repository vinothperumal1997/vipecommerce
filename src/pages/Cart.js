          ...
          <div className="">
            <div className=" h-full w-full mix-blend-multiply flex justify-center items-center ">
              <img
                src={empty}
                alt="empty"
                className=" min-h-34 min-w-56  w-64 "
              />
            </div>
            <p className="py-1">Your cart is empty!</p>
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:justify-center p-4">
        ...
        <div className="mt-5 lg:mt-0 w-full max-w-sm">
          {data.length === 0 || loading ? (
            ...
            <div className="h-36 bg-white  lg:fixed lg:min-w-96">
              <h2 className="text-white bg-red-600 px-4 py-1">Summary</h2>
              <div className="flex w-full items-center justify-between px-4 gap-2 font-medium text-lg text-slate-600">
                <p>Quantity</p>
                <p>{totalQty}</p>
              </div>
